  ...
  data() {
    return {
      assortment: {
        ...
        B: {
          img: "./src/desperados.jpg",
          naam: "Bier op zijn mexicaans",
          prijs: "€3,10",
        },
        C: {
          img: "./src/gerolsteinerCitroen.jpg",
          naam: "Citroentje",
          prijs: "€0,70",
        },
        D: {
          img: "./src/strongbow.png",
        ...
        H: {
          img: "./src/wittewijn.jpg",
          naam: "Hoerendiezel",
          prijs: "€2,20",
        },
        I: {
          img: "./src/colazero.jpg",
          naam: "Ik ben op dieet",
          prijs: "€0,90",
        },
        J: {
          img: "./src/stellaZero.jpg",

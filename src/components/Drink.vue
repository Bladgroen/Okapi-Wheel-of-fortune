...
export default {
  data() {
    return {
      assortment: {
        A: {
          img: "./src/DrinkPictures/Corona.png",
          naam: "Anno 2020",
          prijs: "€3,10",
        },
        B: {
          img: "./src/DrinkPictures/desperados.jpg",
          naam: "Bier op zijn mexicaans",
          prijs: "€3,10",
        },
        C: {
          img: "./src/DrinkPictures/gerolsteinerCitroen.jpg",
          naam: "Citroentje",
          prijs: "€0,70",
        },
        D: {
          img: "./src/DrinkPictures/strongbow.png",
          naam: "De boog moet niet altijd gespannen staan",
          prijs: "€3,10",
        },
        E: {
          img: "./src/DrinkPictures/icetea.jpg",
          naam: "Eerst een theetje!",
          prijs: "€1,00",
        },
        H: {
          img: "./src/DrinkPictures/wittewijn.jpg",
          naam: "Hoerendiezel",
          prijs: "€2,20",
        },
        I: {
          img: "./src/DrinkPictures/colazero.jpg",
          naam: "Ik ben op dieet",
          prijs: "€0,90",
        },
        J: {
          img: "./src/DrinkPictures/stellaZero.jpg",
          naam: "Jari's favourite",
          prijs: "€1,30",
        },
        K: {
          img: "./src/DrinkPictures/Cola.jpg",
          naam: "Kunt niet altijd bier drinken",
          prijs: "€0,90",
        },
        L: {
          img: "./src/DrinkPictures/Rosé.jpg",
          naam: "La Vie en rosé",
          prijs: "€2,20",
        },
        M: {
          img: "./src/DrinkPictures/Duvel.jpg",
          naam: "Moet niet altijd een engeltje zijn",
          prijs: "€2,20",
        },
        O: {
          img: "./src/DrinkPictures/Omer.jpg",
          naam: "Omer hoe beter",
          prijs: "€2,20",
        },
        R: {
          img: "./src/DrinkPictures/Kriek.jpg",
          naam: "Roden bucht",
          prijs: "€1,90",
        },
        S: {
          img: "./src/DrinkPictures/green.jpg",
          naam: "Spill the tea",
          prijs: "€1",
        },
        T: {
          img: "./src/DrinkPictures/stella.jpg",
          naam: "T'is hier geen T-klub",
          prijs: "€1,50",
        },
        V: {
          img: "./src/DrinkPictures/bruiswater.jpg",
          naam: "Voor de durvers onder ons",
          prijs: "€0,60",
        },
        W: {
          img: "./src/DrinkPictures/water.jpg",
          naam: "Water voor de kater",
          prijs: "€0,60",
        },
        Z: {
          img: "./src/DrinkPictures/Rouge.jpg",
        ...
        G: {
          img: "./src/DrinkPictures/cornet.png",
          naam: "Goe, Cornetje?",
          prijs: "€2,30",
        },
      },
